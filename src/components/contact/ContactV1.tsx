                ...
                <div className="custom-row">
                    <div className="left">
                        <div className="contact-content">
                            ...
                            <p>
                                <span className="required">*</span> Whether you have a question, or want to discuss a potential project, our team at <br /> XANDERKROFT is here to help. Please fill out the form below!!!
                            </p>
