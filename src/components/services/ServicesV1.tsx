            ...
            <div className="service-sec" id="services">
                <div className="custom-container">
                    <div className="section-header">
                        ...
                        <AnimatedText>
                            {`At XANDERKROFT, we offer tailored creative solutions to execute and drive success, exceeding your expectations with our expert team's dedicated services.`}
                        </AnimatedText>
                    </div>
                </div>
